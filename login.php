...
<head>
    ...
    <title>Login - Pendaftara Kades Baru</title>
                            ...
                            <div class="col-md-12">
                                <div class="p-5">
                                    <div class="text-center">
                                        ...
                                        <h3 class="h4 text-gray-900 ">Login Aplikasi Pendaftaran Kepala DESA!</h3>
                                        <h1 class="h4 text-gray-900 mb-4"><b>Dinas Pemberdayaan Masyarakat dan Desa KAB. Garut</b></h1>
